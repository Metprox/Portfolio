...
var $aboutArr = $('.page-about-inner p');
...
$aboutArr.each(function(k,e) {
    $(e).css('transition-delay', aboutDel + 's');
    aboutDel += 0.15;
})
...
$(document).ready(function () {
    ...
    if (window.innerWidth <= 500) {
        ...
        // $('.select2-selection__rendered img').attr('src');
    }
    ...
    orderTimer.addEventListener('secondsUpdated', function (e) {
        ...
        // console.log($('#order-timer .order-min').html());
        // $('.time-info-start').addClass('show');
        // if(parseFloat($('.timeline-inner').css('width')) > parseFloat($('.timeline').css('width')) / 2 - step) {
            // $('.dot-middle').addClass('colored');
            // $('.time-info-mdl').addClass('show');
        // }
        ...
        // lineWidth += step;
        // $('.timeline-inner').css('width', lineWidth + '%');
    });
    ...
    function formatState (state) {
        ...
        var baseUrl = "../images";
        var $state = $(
            '<img src="' + baseUrl + '/' + state.element.value.slice(0,state.element.value.indexOf(" ")).toLowerCase() + '.png" class="curr-ico" /> ' + '<div>' + '<span class="curr-abbr">' +  state.element.value.slice(0,state.element.value.indexOf(" ")).toUpperCase() + '</span>' + state.element.value.slice(state.element.value.indexOf(" ")) +  '</div>'
        );
        return $state;
    }
    ...
    // if (window.innerWidth <= 500) {
    //
    //     var $selectRendImg = $('.select2-selection__rendered img');
    //
    //     if($selectRendImg.length){
    //         var imgSrc = $selectRendImg.attr('src').slice(0, -4);
    //         $selectRendImg.attr('src', imgSrc + '_white.png');
    //         $('.sell-select').on('select2:close', function(e) {
    //
    //
    //                 imgSrc = $selectRendImg.attr('src').slice(0, -4).toLowerCase();
    //                 console.log(imgSrc);
    //
    //         })
    //
    ...
    // $('.terms-item').on('click', function () {
    //     $(this).children('.terms-item-dropdwn').toggleClass('show');
    // })
...
// MODAL COPY
    ...
    $('.lang-select').each(function(){
        ...
        for (var i = 0; i < numberOfOptions; i++) {
            ...
            $(li).append(a);
            li.setAttribute('class', $this.children('option').eq(i).text().toLowerCase().slice(0,2));
            $($list).append(li);
            // $a.text($this.children('option').eq(i).text());
            // $('<a href="#"></a>', {
        ...
        var curLang = $('.select-styled').text().toLowerCase().slice(0,2);
        ...
        $listItems.click(function(e) {
            ...
            $styledSelect.addClass($(this).text().toLowerCase().slice(0,2));
            curLang = $(this).text().toLowerCase().slice(0,2);
            setTimeout(function () {
...
// $('.code-input').unbind('keyup change input paste').bind('keyup change input paste',function(e){
//     var $this = $(this);
//     var val = $this.val();
